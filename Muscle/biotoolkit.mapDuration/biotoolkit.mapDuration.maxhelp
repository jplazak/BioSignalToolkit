...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 227.5, 126.0, 40.0, 19.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 30.5, 259.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 30.5, 222.0, 144.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 155.5, 164.0, 91.0, 21.0 ],
					"text" : "biotoolkit.ARV"
				}
...
, 			{
				"box" : 				{
					...
					"text" : "Outputs the duration of each motor action potential duration (in ms)"
				}
...
, 			{
				"name" : "biotoolkit.mapDuration.maxpat",
				"bootpath" : "/Applications/Max 6.1/externals/BioSignalToolkit/alphaRelease/Muscle/biotoolkit.mapDuration",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
