...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 171.0, 135.0, 40.0, 19.0 ],
					"text" : "clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 30.5, 217.0, 94.0, 21.0 ],
					"text" : "dot.smooth 40"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 30.5, 126.0, 94.0, 21.0 ],
					"text" : "dot.smooth 20"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 83.0, 263.5, 82.0, 24.0 ],
					"text" : "% Effort"
				}
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 0,
					"patching_rect" : [ 30.5, 265.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 399.5, 115.0, 37.0, 21.0 ],
					"text" : "MAX"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 367.5, 115.0, 32.0, 21.0 ],
					"text" : "MIN"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.5, 166.0, 100.0, 21.0 ],
					"text" : "prepend range"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 317.5, 115.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "float", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 267.5, 115.0, 50.0, 21.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 267.5, 142.0, 47.0, 21.0 ],
					"text" : "pak f f"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 30.5, 180.0, 159.0, 21.0 ],
...
, 			{
				"box" : 				{
					...
					"text" : "Outputs the current signal strength recording relative to max value"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 206.25, 203.0, 239.0, 107.0 ],
					"setminmax" : [ 0.0, 0.08 ],
					"setstyle" : 5,
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 40.0, 156.0, 215.75, 156.0 ],
					"source" : [ "obj-3", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"disabled" : 0,
					"hidden" : 1,
					"midpoints" : [ 327.0, 137.5, 305.0, 137.5 ],
					"source" : [ "obj-55", 0 ]
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "biotoolkit.strengthPercent.maxpat",
				"bootpath" : "/Applications/Max 6.1/externals/BioSignalToolkit/alphaRelease/Muscle/biotoolkit.strengthPercent",
				"patcherrelativepath" : ".",
				"type" : "JSON",
				"implicit" : 1
			}
